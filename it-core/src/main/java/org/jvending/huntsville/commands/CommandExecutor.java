 ...
 * the License.
 */
package org.jvending.huntsville.commands;
...
public interface CommandExecutor
{
     ...
     *             if compiler or executable writes anything to the standard
     *             error stream or if the process returns a process result != 0.
     */
     ...
     *            if true, throws an <code>ExecutionException</code> if there
     *            the compiler or executable writes anything to the error output
     *            stream. By default, this value is true
     * @throws ExecutionException
     *             if compiler or executable writes anything to the standard
     *             error stream (provided the failsOnErrorOutput is not false)
     *             or if the process returns a process result != 0.
     */
    ...
    /**
     * Executes the command for the specified executable and list of command
     * options. If the compiler or executable is not within the environmental
     * path, you should use this method to specify the working directory. Always
     * use this method for executables located within the local maven
     * repository.
     * 
     * @param executable
     *            the name of the executable (csc, xsd, etc).
    ...
    /**
     * Provides factory services for creating a default instance of the command
     * executor.
     */
    public static class Factory
    {
        ...
        public static CommandExecutor createDefaultCommmandExecutor()
        {
            return new CommandExecutor()
            {
                ...
                /**
                 * Provides behavior for determining whether the command utility
                 * wrote anything to the Standard Error Stream. NOTE: I am using
                 * this to decide whether to fail the NMaven build. If the
                 * compiler implementation chooses to write warnings to the
                 * error stream, then the build will fail on warnings!!!
                 */
